...
def start(app, message):
    text = """⚡️ <b><u>What is Rotom-2.0?</u></b>
Rotom-2.0 is a bot which acts as a helper for trainers on Telegram. \
You can check information of Pokemon, Showdown usage and more as quickly as possible, without ever leaving Telegram\n
🛠 <b><u>Usage</u></b>
Just write Pokemon name after @MadBoy_Rotomgram2_Bot (e.g.: @MadBoy_Rotomgram2_Bot Lunala)\n
@Warning_MadBoy_is_Here | <a href="github.com/madboy482/rotom-2.0">GitHub</a>"""
    app.send_message(
